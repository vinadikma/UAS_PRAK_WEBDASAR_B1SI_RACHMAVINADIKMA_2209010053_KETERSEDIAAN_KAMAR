        ...
        @foreach($rooms)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('rooms.destroy', $room->id) }}">Delete</a>
                </td>
            </tr>
        @endforeach
    </tbody>
...
<form method="POST" action="{{ route('rooms.update', $room->id) }}">
    ...
    @method('PUT')
    <label for="room_number">Room Number:</label>
    <input type="text" id="room_number" name="room_number" value="{{ $room->room_number }}"><br><br>
    <label for="room_type">Room Type:</label>
    <input type="text" id="room_type" name="room_type" value